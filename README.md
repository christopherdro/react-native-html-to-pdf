...
1. Run `npm install rn-html-to-pdf --save`
...
```java
include ':rn-html-to-pdf'
project(':rn-html-to-pdf').projectDir = new File(rootProject.projectDir,'../node_modules/rn-html-to-pdf/android')
```
...
dependencies {
  ....
  compile project(':rn-html-to-pdf')
